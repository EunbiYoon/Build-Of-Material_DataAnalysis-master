...
###########################GERP###############################
gerp=pd.read_excel('C:/Users/RnD Workstation/Documents/NPTGERP/0526/FL/gerp.xlsx')
# #파일에 따라 추가하기
...
gerp.to_excel('C:/Users/RnD Workstation/Documents/NPTGERP/0526/FL/gerpresult.xlsx')

###########################NPT###############################
npt=pd.read_excel('C:/Users/RnD Workstation/Documents/NPTGERP/0526/FL/npt.xlsx')
...
npt.to_excel('C:/Users/RnD Workstation/Documents/NPTGERP/0526/FL/nptresult.xlsx')
...
for i in range(len(npt)):
    ...
    npt_qty=npt.at[i,"Unit Qty"]
    match_number=npt.at[i,"Seq."]
    if npt_des=='Sheet,Steel(PCM)':
        for j in range(len(unique_gerp)): #duplicate 제외
            gerp_subpart=unique_gerp.at[j,"Child Item"][:-2]
            gerp_des=unique_gerp.at[j,"Description"]
            gerp_price=unique_gerp.at[j,"QPA*Material Cost"]
            gerp_qty=unique_gerp.at[j,"Qty Per Assembly"]
            if gerp_des=='Sheet,Steel(GI)' and gerp_subpart==npt_subpart:
                gerp_data=unique_gerp.at[j,"Seq"]
...
remain_gerp.to_excel('C:/Users/RnD Workstation/Documents/NPTGERP/0526/FL/remaingerp.xlsx')
...
match_list.to_excel('C:/Users/RnD Workstation/Documents/NPTGERP/0526/FL/matchlist.xlsx')
...
#save file
match_join.to_excel('C:/Users/RnD Workstation/Documents/NPTGERP/0526/FL/matchjoin.xlsx')
...
#######################Add MTL Column####################
mtl=pd.read_excel('C:/Users/RnD Workstation/Documents/NPTGERP/0526/FL/gerp.xlsx',sheet_name='MTL Cost')
...
final_table.to_excel('C:/Users/RnD Workstation/Documents/NPTGERP/0526/FL/final_table.xlsx')